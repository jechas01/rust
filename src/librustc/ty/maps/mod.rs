...
define_maps! { <'tcx>
    ...
    /// instead.
    [] fn crate_variances: crate_variances(CrateNum) -> Arc<ty::CrateVariancesMap>,

    /// Maps from def-id of a type or region parameter to its
    /// (inferred) variance.
    [] fn variances_of: ItemVariances(DefId) -> Arc<Vec<ty::Variance>>,

    /// Maps from def-id of a type to its (inferred) outlives.
    [] fn inferred_outlives_of: InferredOutlivesOf(DefId) -> Vec<ty::Predicate<'tcx>>,

    /// Maps from an impl/trait def-id to a list of the def-ids of its items
    [] fn associated_item_def_ids: AssociatedItemDefIds(DefId) -> Arc<Vec<DefId>>,
    ...
    [] fn inherent_impls: InherentImpls(DefId) -> Arc<Vec<DefId>>,

    /// Set of all the def-ids in this crate that have MIR associated with
    /// them. This includes all the body owners, but also things like struct
    /// constructors.
    [] fn mir_keys: mir_keys(CrateNum) -> Arc<DefIdSet>,

    /// Maps DefId's that have an associated Mir to the result
    /// of the MIR qualify_consts pass. The actual meaning of
    /// the value isn't known except to the pass itself.
    [] fn mir_const_qualif: MirConstQualif(DefId) -> (u8, Arc<IdxSetBuf<mir::Local>>),
    ...
    [] fn used_trait_imports: UsedTraitImports(DefId) -> Arc<DefIdSet>,

    [] fn has_typeck_tables: HasTypeckTables(DefId) -> bool,

    [] fn coherent_trait: coherent_trait_dep_node((CrateNum, DefId)) -> (),

    [] fn borrowck: BorrowCheck(DefId) -> Arc<BorrowCheckResult>,
    ...
    [] fn privacy_access_levels: PrivacyAccessLevels(CrateNum) -> Arc<AccessLevels>,
    ...
    [] fn region_scope_tree: RegionScopeTree(DefId) -> Arc<region::ScopeTree>,
    ...
    [] fn item_attrs: ItemAttrs(DefId) -> Arc<[ast::Attribute]>,
    ...
    [] fn rvalue_promotable_map: RvaluePromotableMap(DefId) -> Arc<ItemLocalSet>,
    [] fn is_mir_available: IsMirAvailable(DefId) -> bool,
    [] fn vtable_methods: vtable_methods_node(ty::PolyTraitRef<'tcx>)
                          -> Arc<Vec<Option<(DefId, &'tcx Substs<'tcx>)>>>,

    [] fn trans_fulfill_obligation: fulfill_obligation_dep_node(
        (ty::ParamEnv<'tcx>, ty::PolyTraitRef<'tcx>)) -> Vtable<'tcx, ()>,
    [] fn trait_impls_of: TraitImpls(DefId) -> Arc<ty::trait_def::TraitImpls>,
    [] fn specialization_graph_of: SpecializationGraph(DefId) -> Arc<specialization_graph::Graph>,
    ...
    [] fn dylib_dependency_formats: DylibDepFormats(CrateNum)
                                    -> Arc<Vec<(CrateNum, LinkagePreference)>>,
    ...
    [] fn extern_crate: ExternCrate(DefId) -> Arc<Option<ExternCrate>>,
    ...
    [] fn lint_levels: lint_levels_node(CrateNum) -> Arc<lint::LintLevelMap>,

    [] fn impl_defaultness: ImplDefaultness(DefId) -> hir::Defaultness,
    [] fn exported_symbol_ids: ExportedSymbolIds(CrateNum) -> Arc<DefIdSet>,
    [] fn native_libraries: NativeLibraries(CrateNum) -> Arc<Vec<NativeLibrary>>,
    ...
    [] fn link_args: link_args_node(CrateNum) -> Arc<Vec<String>>,
    ...
    [] fn item_children: ItemChildren(DefId) -> Arc<Vec<Export>>,
    [] fn extern_mod_stmt_cnum: ExternModStmtCnum(DefId) -> Option<CrateNum>,

    [] fn get_lang_items: get_lang_items_node(CrateNum) -> Arc<LanguageItems>,
    [] fn defined_lang_items: DefinedLangItems(CrateNum) -> Arc<Vec<(DefId, usize)>>,
    [] fn missing_lang_items: MissingLangItems(CrateNum) -> Arc<Vec<LangItem>>,
    [] fn extern_const_body: ExternConstBody(DefId) -> ExternConstBody<'tcx>,
    [] fn visible_parent_map: visible_parent_map_node(CrateNum)
        -> Arc<DefIdMap<DefId>>,
    [] fn missing_extern_crate_item: MissingExternCrateItem(CrateNum) -> bool,
    [] fn used_crate_source: UsedCrateSource(CrateNum) -> Arc<CrateSource>,
    [] fn postorder_cnums: postorder_cnums_node(CrateNum) -> Arc<Vec<CrateNum>>,
    ...
    [] fn stability_index: stability_index_node(CrateNum) -> Arc<stability::Index<'tcx>>,
    [] fn all_crate_nums: all_crate_nums_node(CrateNum) -> Arc<Vec<CrateNum>>,
