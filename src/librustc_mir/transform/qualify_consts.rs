...
impl<'a, 'tcx> Qualifier<'a, 'tcx, 'tcx> {
    ...
    fn qualify_const(&mut self) -> (Qualif, Arc<IdxSetBuf<Local>>) {
        ...
        (self.qualif, Arc::new(promoted_temps))
    }
}
...
fn mir_const_qualif<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>,
    ...
    if mir.return_ty.references_error() {
        ...
        return (Qualif::NOT_CONST.bits(), Arc::new(IdxSetBuf::new_empty(0)));
    }
