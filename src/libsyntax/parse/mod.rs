...
impl ParseSess {
    pub fn new(file_path_mapping: FilePathMapping) -> Self {
        ::rustc_data_structures::lock::assert_sync::<Self>();
        let cm = Arc::new(CodeMap::new(file_path_mapping));
    ...
    pub fn with_span_handler(handler: Handler, code_map: Arc<CodeMap>) -> ParseSess {
        ParseSess {
